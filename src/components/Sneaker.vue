        ...
        <div class="container h-100 position-relative text-light text-center">
            <div class="row m-0 p-0 mt-3 py-0 px-0 bg-blue rounded ">
                ...
                <div class="col-12 mb-2 text-center text-dark justify-content-center">
                    <span class="px-3 py-2 h3 fw-bold rounded" :class="colorlabel">{{ stringId }}</span>
                </div>
                ...
                <div class="col-15 valign ps-5"><img class="smallz whiteIcons" src="@/img/tag.svg"></div>
                ...
                <div class="sizeRow row m-0 p-0">
                    <div class="col-3 valign ps-5"><img class="smallz whiteIcons" src="@/img/ruler.svg"></div>
                ...
                <hr class="w-95 mx-auto my-2 opacity-25">
                <div class="sizeRow row m-0 p-0">
                    <div class="col-3 valign ps-5"><img class="smallz whiteIcons" src="@/img/paint.svg"></div>
                    <div class="col-9 text-end pe-5 text-success" v-if="paint">✔</div>
                    <div class="col-9 text-end pe-5 text-danger" v-else>❌</div>
                </div>
                <hr class="w-95 mx-auto my-2 opacity-25">
                <div class="sizeRow row m-0 p-0">
                    <div class="col-3 valign ps-5"><img class="smallz whiteIcons" src="@/img/broken.svg"></div>
                ...
                <div class="sizeRow row m-0 p-0">
                    <div class="col-3 valign ps-5"><img class="smallz whiteIcons" src="@/img/baknr.svg"></div>
                    <div class="col-9 text-end pe-5">{{bakNr}}</div>
                </div>
                <hr class="w-95 mx-auto my-2 opacity-25">
                <div class="sizeRow row m-0 p-0">
                    <div class="col-3 valign ps-5"><img class="smallz whiteIcons" src="@/img/warning.svg"></div>
                    <div class="col-9 text-end pe-5">{{status}}</div>
                </div>
                <hr class="w-95 mx-auto my-2 opacity-25">
                <div class="sizeRow row m-0 p-0">
                    <div class="col-3 valign ps-5"><img class="smallz whiteIcons" src="@/img/extra.svg"></div>
                    <div class="col-9 text-end pe-5">{{extra}}</div>
                </div>
                <hr class="w-95 mx-auto my-2 opacity-25">
                <div class="sizeRow row m-0 p-0">
                    <div class="col-3 valign ps-5"><img class="smallz whiteIcons" src="@/img/delivery.svg"></div>
                    <div class="col-9 text-end pe-5">{{supplier}}</div>
                </div>
                <hr class="w-95 mx-auto my-2 opacity-25">
                <div class="sizeRow row m-0 p-0">
                    <div class="col-3 valign ps-5"><img class="smallz whiteIcons" src="@/img/login.svg"></div>
                    <div class="col-9 text-end pe-5">{{creator}}</div>
                </div>
                <hr class="w-95 mx-auto my-2 opacity-25">
                <div class="sizeRow row m-0 p-0">
                    <div class="col-3 valign ps-5"><img class="smallz whiteIcons" src="@/img/clock.svg"></div>
