<template>
  ...
  <div class="main row m-0 p-0 pt-4">
    <div class="col-1 col-xl-2"></div>
    <div class="col-10 col-xl-8 p-0 m-0 text-start">
      <router-view/><!--  @scroll.prevent @wheel.prevent -->
    </div>
    <div class="col-1 col-xl-2"></div>
  </div>

  <div class="footer-main row m-0 p-0 text-start bg-blue borderz-top border-blue">
    <div class="col-0 col-xl-1"></div>
